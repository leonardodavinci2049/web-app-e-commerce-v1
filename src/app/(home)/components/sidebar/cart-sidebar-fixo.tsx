...
// Componente interno que contém a lógica do carrinho
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="h-8 w-8 p-0"
                    disabled={item.quantity >= (item.maxQuantity ?? item.stock)}
                  >
...
// Componente principal que usa ClientOnly para evitar problemas de hidratação
      ...
      <ClientOnly
        fallback={
          <Card className="border-2 border-blue-200 dark:border-blue-800">
            ...
            <CardContent className="p-6">
              <div className="text-center py-8">
                <ShoppingCart className="w-12 h-12 mx-auto text-muted-foreground mb-4 animate-pulse" />
